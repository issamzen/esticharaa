...
export function SiteLayout({ children }: { children: ReactNode }) {
  ...
  return <div className="min-h-screen overflow-x-clip bg-background pb-20 md:pb-0"><Header/><StickyCategoryBar/><main>{children}</main><Footer/><ScrollToTop/><MobileBottomNav/></div>;
}
