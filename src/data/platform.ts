...
export const categories: Category[] = [
  { slug: "health", name: "Health", icon: "HeartPulse", questions: 1284, answers: 3120, experts: 86 },
  { slug: "legal", name: "Legal", icon: "Scale", questions: 942, answers: 2210, experts: 64 },
  { slug: "education", name: "Education", icon: "GraduationCap", questions: 1105, answers: 2740, experts: 91 },
  { slug: "technology", name: "Technology", icon: "Cpu", questions: 1630, answers: 4180, experts: 124 },
  { slug: "automotive", name: "Automotive", icon: "Car", questions: 610, answers: 1420, experts: 38 },
  { slug: "real-estate", name: "Real Estate", icon: "Building2", questions: 780, answers: 1610, experts: 47 },
  { slug: "finance", name: "Finance", icon: "Landmark", questions: 865, answers: 1980, experts: 55 },
  { slug: "business", name: "Business", icon: "Briefcase", questions: 720, answers: 1530, experts: 49 },
  { slug: "immigration", name: "Immigration", icon: "Plane", questions: 990, answers: 2050, experts: 41 },
  { slug: "jobs", name: "Jobs", icon: "UserSearch", questions: 1180, answers: 2360, experts: 58 },
  { slug: "family", name: "Family", icon: "Users", questions: 540, answers: 1290, experts: 33 },
  { slug: "travel", name: "Travel", icon: "Map", questions: 470, answers: 980, experts: 27 },
  { slug: "administration", name: "Administration", icon: "FileText", questions: 830, answers: 1740, experts: 36 },
  { slug: "agriculture", name: "Agriculture", icon: "Sprout", questions: 320, answers: 690, experts: 19 },
  { slug: "construction", name: "Construction", icon: "HardHat", questions: 410, answers: 870, experts: 24 },
  { slug: "entrepreneurship", name: "Entrepreneurship", icon: "Rocket", questions: 650, answers: 1410, experts: 44 },
  { slug: "insurance", name: "Insurance", icon: "ShieldCheck", questions: 380, answers: 810, experts: 21 },
  { slug: "telecommunications", name: "Telecommunications", icon: "Signal", questions: 290, answers: 540, experts: 15 },
  { slug: "government-services", name: "Government Services", icon: "Landmark", questions: 700, answers: 1450, experts: 30 },
  { slug: "other", name: "Other", icon: "Sparkles", questions: 260, answers: 520, experts: 12 },
];
...
export const questions: Question[] = [
  ...
  },
  {
    ...
    title: "My French visa was refused twice — what changes my odds on the third try?",
  ...
  {
    id: "apartment-title",
    title: "Buying an apartment without a clean land title (titre foncier) — is it ever safe?",
  ...
  {
    id: "startup-taxes",
    title: "What taxes does a Moroccan SARL actually pay in its first two years?",
    category: "Finance",
  ...
  {
    id: "unfair-dismissal",
    title: "Dismissed after 6 years without written notice — what compensation am I owed?",
    category: "Legal",
    categorySlug: "legal",
    tokens: 10,
    answers: 2,
...
export const tokenPacks = [
  { name: "Starter", tokens: 100, price: 99, perToken: 0.99, bonus: 0, popular: false },
  { name: "Standard", tokens: 500, price: 449, perToken: 0.9, bonus: 25, popular: true },
  { name: "Pro", tokens: 1000, price: 849, perToken: 0.85, bonus: 100, popular: false },
  { name: "Enterprise", tokens: 5000, price: 3799, perToken: 0.76, bonus: 750, popular: false },
];
